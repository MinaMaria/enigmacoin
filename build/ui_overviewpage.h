...
public:
    ...
    void setupUi(QWidget *OverviewPage)
    {
		...
		label_5->setStyleSheet(QString::fromUtf8("QLabel { color: black; }"));
        QFont font;
        ...
        labelBalance->setText(QString::fromUtf8("0 XNG"));
		labelBalance->setStyleSheet(QString::fromUtf8("QLabel { color: black; }"));
		...
		label_6->setStyleSheet(QString::fromUtf8("QLabel { color: black; }"));
        ...
        labelUnconfirmed->setText(QString::fromUtf8("0 XNG"));
        labelUnconfirmed->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
		labelUnconfirmed->setStyleSheet(QString::fromUtf8("QLabel { color: black; }"));
		...
		labelImmatureText->setStyleSheet(QString::fromUtf8("QLabel { color: black; }"));
        ...
        labelImmature->setText(QString::fromUtf8("0 XNG"));
        labelImmature->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
		labelImmature->setStyleSheet(QString::fromUtf8("QLabel { color: black; }"));
		...
		labelTotalText->setStyleSheet(QString::fromUtf8("QLabel { color: black; }"));
        ...
        labelTotal->setText(QString::fromUtf8("0 XNG"));
        labelTotal->setTextInteractionFlags(Qt::LinksAccessibleByMouse|Qt::TextSelectableByKeyboard|Qt::TextSelectableByMouse);
		labelTotal->setStyleSheet(QString::fromUtf8("QLabel { color: black; font-family:'Tahoma'; }"));
        ...
        //label_2->setPixmap(QPixmap(QString::fromUtf8("")));
    ...
    void retranslateUi(QWidget *OverviewPage)
    {
        ...
        labelWalletStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the EnigmaCoin network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        labelTransactionsStatus->setToolTip(QApplication::translate("OverviewPage", "The displayed information may be out of date. Your wallet automatically synchronizes with the EnigmaCoin network after a connection is established, but this process has not completed yet.", 0, QApplication::UnicodeUTF8));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
